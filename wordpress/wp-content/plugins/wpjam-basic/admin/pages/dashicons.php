...
function wpjam_dashicons_page(){
	...
	jQuery(function($){
		$('body').on('click', 'div.wpjam-dashicons p', function(){
			...
			$('#tb_modal').html('<p><span class="dashicons '+dashicon+'"></span></p><p style="max-width:450px; margin-left:20px;">'+dashicon+'<br /><br />HTML：<br /><code>'+dashicon_html+'</code></p>');
			tb_show(dashicon, '#TB_inline?inlineId=tb_modal&height=240');
			tb_position();
		});
	});
	</script>
