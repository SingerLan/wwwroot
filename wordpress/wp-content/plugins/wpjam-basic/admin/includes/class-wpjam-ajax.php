...
class WPJAM_AJAX{
	public static function ajax_response(){
		global $plugin_page, $current_tab, $current_admin_url, $current_page_file;
		...
		$ajax_response_callback	= $ajax_response_callback ?? wpjam_get_filter_name($plugin_page, 'ajax_response');

		call_user_func($ajax_response_callback);
	}
