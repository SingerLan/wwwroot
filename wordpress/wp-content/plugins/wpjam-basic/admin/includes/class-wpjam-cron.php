...
class WPJAM_Cron{
	...
	public static function get_fields($action_key='', $id=0){
		...
		$interval_options	= [''=>'once']+array_combine(array_keys($intervals), array_keys($intervals));
		return [
			...
			'interval'	=> ['title'=>'频率',		'type'=>'select',	'show_admin_column'=>true,	'options'=>$interval_options],
		];
	}
}