...
$(function ($) {
   ...
   $(".search-link i.icon-close").on("click", function (event) {
      event.preventDefault()
      $(".search-link i.icon-search").addClass("show");
      $(".search-link form .search-box").removeClass("show");
      $(".search-link i.icon-close").removeClass("show");
   });
   $(".search-link i.icon-search").on("click", function () {
      ...
      $(".search-link i.icon-close").addClass("show");
   });
...
(jQuery),+function(t){var l=jQuery("body"),d={postlike:function(t){var e=t.data();if(!t.hasClass("is-active")){var a=t.find(".count");t.addClass("is-active"),l.addClass("is-loadingApp"),jQuery.ajax({url:zb.admin_url,type:"POST",dataType:"json",data:e,success:function(t){a.html(t.data),l.removeClass("is-loadingApp")}})}}},v=0;jQuery(document).on("click",".js-action",function(t){t.preventDefault();var e=jQuery(this),a=e.data("action");return a&&d[a](e),!1}),window.LEE=d}(jQuery);jQuery(document).ready(function($){$(".cd-popup-trigger").on("click",function(event){event.preventDefault();$(".cd-popup").addClass("is-visible")});$(".cd-popup").on("click",function(event){if($(event.target).is(".cd-popup-close")||$(event.target).is(".cd-popup")){event.preventDefault();$(this).removeClass("is-visible")}});$(document).keyup(function(event){if(event.which=="27"){$(".cd-popup").removeClass("is-visible")}})});