...
class Options_Framework_Admin {
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复出厂设置', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( '设置保存成功.', 'theme-textdomain' ), 'updated fade' );
	}
