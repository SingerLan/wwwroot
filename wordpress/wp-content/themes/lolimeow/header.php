...
<head>
  ...
  <link type="text/css" href="<?php echo meowdata('style_src') ;?>/assets/css/themes.min.css" rel="stylesheet">
  <link type="text/css" href="<?php echo meowdata('style_src') ;?>/assets/css/animate.min.css" rel="stylesheet">
  <link type="text/css" href="<?php echo meowdata('style_src') ;?>/assets/css/style.css" rel="stylesheet">   
...
<li class="nav-item"><a href="<?php echo wp_logout_url( home_url() ); ?>" class="dropdown-item"><i class="fa fa-sign-out"></i>注销登录</a></li></ul></li><?php } ?>		           
 ...
 <a href="<?php echo site_url('') ?>/login" class="signin-loader z-bor">登录</a> 
 <b class="middle-text"><span class="middle-inner">or</span></b> 
 </span> <span class="ruike_user-loader">
 <a href="<?php echo site_url('') ?>/reg" class="signup-loader l-bor">注册</a></span> 
