...
?>
 ...
 <div id="comments" class="comments-area thw-sept wow bounceInUp">
  ...
  <li>
									<?php
										wp_list_comments( 'type=comment&callback=meowdata_comments_list' );
                                        wp_list_comments( 'type=pings&callback=meowdata_comments_list' );
									?> 
...
<h3 class="title-normal thw-sept text-center wow swing ">留下你的评论</h3>
