...
<?php if(!empty($error)) {
 echo '<div class="text-muted text-center mt-3"><span class="badge badge-pill badge-danger text-uppercase">'.$error.'</span></div>';
              ...
              <div class="card-body px-lg-5 py-lg-5">
                ...
                <form method="post" action="<?php echo site_url(); ?>/wp-login.php" novalidate="novalidate">
				  ...
				  <input type="hidden" name="redirect_to" value="<?php echo site_url('/') ?><?php echo meowdata('users_page') ?>" />
