...
<style>.featured-item .entry-header {max-width: 100%}.dialog-content .btn-close {top: 15px;right: -140px;bottom: auto;left: auto;}.dialog_overlay {position: initial;}</style>
<div id="featured" class="featured featured-height-full">
	<div class="featured-item">
		<div class="featured-media">
			<img src="<?php echo get_post_meta($post->ID, 'header_img', true);?>" alt="<?php the_title(); ?>" sizes="100vw" width="1920" height="1280">
