...
<?php if(is_home()&&!is_paged()){ ?>
	<div id="featured" class="featured featured-height-half">
		<div id="featured-carousel" class="featured-carousel">
		<?php  
			$sticky = get_option('sticky_posts');  
			rsort( $sticky );  
			$sticky = array_slice( $sticky, 0, 10);  
			query_posts( array( 'post__in' => $sticky, 'ignore_sticky_posts'=>10, 'posts_per_page'=>10) );
			if (have_posts()) :  
...
<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/static/js/init-carousel-2.js'></script>
<?php } ?>
