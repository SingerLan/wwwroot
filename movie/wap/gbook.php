...
function leaveWordList($currentPage){
	...
	$txt.="<li><a title='首页' href=\"/".$GLOBALS['cfg_cmspath']."wap/gbook.php?page=1\">首页</a></li><li><a title='前一页' href=\"/".$GLOBALS['cfg_cmspath']."wap/gbook.php?page=".($currentPage-1)."\">上一页</a></li>";
	}
	...
	if($currentPage==$TotalPage){
		...
		$txt.="<li><a href=\"/".$GLOBALS['cfg_cmspath']."wap/gbook.php?page=".($currentPage+1)."\">下一页</a></li> <li><a href=\"/".$GLOBALS['cfg_cmspath']."wap/gbook.php?page=".$TotalPage."\">尾页</a></li>";
	}
	 return $txt."</ul>";
	} else {
		return $txt;
