...
var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript("http://cdn.staticfile.org/flickity/2.1.2/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript("http://cdn.staticfile.org/jquery.lazyload/1.9.1/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
